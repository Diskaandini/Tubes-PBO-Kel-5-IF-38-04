...
//    private Tugas[] tugas = new Tugas[10] ;
    ...
    public void addProy(int idMp, Proyek proy) {
        System.out.println(idMp);
        this.mp[idMp].createProyek(proy.getID(), proy.getJudul(), proy.getDeadline());
...
//    }
    ...
    public void removeProgrammer(int index) {
        for (int i = index + 1; i < this.cpro; i++) {
            this.programmer[i - 1] = this.programmer[i];
        }
        this.cpro--;
    }

    public void addTugas(int mp, int proyek, Tugas tugas) {
//        if(ct<11){
//            this.tugas[ct] = tugas;
//            ct++;
//        }
        this.mp[mp].getProyek(proyek).createTugas(id, username, true);

    }

    public Tugas getTugas(int mp, int proy, int index) {
        return this.mp[mp].getProyek(proy).getTugas(index);
    }
    ...
    public void menuDua() {
        ...
        System.out.println("============");
        System.out.println("masukan index manager proyek : ");
        int indexMp = inputInt.nextInt();
        System.out.println("ID Proyek : ");
        id = input.nextLine();
        System.out.println("Judul Proyek :");
        Nama = input.nextLine();
        System.out.println("Deadline : ");
        String deadline = input.nextLine();
        Proyek proy = new Proyek(id, Nama, deadline);
        addProy(indexMp, proy);
    ...
    public void menuTiga() {
        ...
        System.out.println("=================");
        System.out.println("ID Programmer : ");
        id = input.nextLine();
        System.out.println("Nama Programmer :");
        Nama = input.nextLine();
        System.out.println("Tanggal Lahir   : ");
        TanggalLahir = input.nextLine();
        System.out.println("No HP :");
    ...
    public void menuEmpat() {
        ...
        System.out.println("============");
        System.out.println("masukan index maneger proyek : ");
        int imd = inputInt.nextInt();
        System.out.println("Index Proyek :");
        int iproy = inputInt.nextInt();
        System.out.println("Judul Tugas :");
        String judul = input.nextLine();
        System.out.println("Deskripsi : ");
        String deskripsi = input.nextLine();
        System.out.println("Status : ");
        boolean status = input.nextBoolean();
        Tugas tugas = new Tugas(judul, deskripsi, status);
        addTugas(imd, iproy, tugas);
    }
...
//        }
        ...
        for (int i = 0; i < this.cpm; i++) {
            for (int j = 0; j < this.mp[i].getNProyek(); j++) {
                System.out.println(this.mp[i].getProyek(j).getJudul());
            }
...
//        }
        ...
        for (int i = 0; i < this.cpm; i++) {
            for (int j = 0; j < this.mp[i].getNProyek(); j++) {
                for (int k = 0; k < this.mp[i].getProyek(j).getNTugas(); k++) {
                    System.out.println(this.mp[i].getProyek(j).getTugas(k).getJudultugas());
                }
            }
        }
    }
